        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-20">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              {[
                { label: 'X', path: 'https://x.com/Hashtag_Jemtec', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><text x="12" y="17" textAnchor="middle" fontSize="17" fontWeight="900" fontFamily="Arial, sans-serif">X</text></svg> },
                ...
                { label: 'YouTube', path: 'https://www.youtube.com/@hashtagjemtec', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="3" ry="3" fill="none" stroke="currentColor"/><polygon points="10.5,9.5 16,12 10.5,14.5" fill="currentColor" stroke="none"/></svg> },
              ].map((social) => (
                <a
                  key={social.label}
                  href={social.path}
