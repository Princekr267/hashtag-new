  ...
  return (
    <footer className="relative border-t mt-20" style={{ borderColor: 'rgba(143,245,255,0.06)' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-20">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-surface-var flex items-center justify-center border border-outline-var text-text-muted hover:text-primary hover:border-primary transition-all hover:scale-110" aria-label="Twitter">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/></svg>
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-surface-var flex items-center justify-center border border-outline-var text-text-muted hover:text-pink-400 hover:border-pink-400 transition-all hover:scale-110" aria-label="Instagram">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-surface-var flex items-center justify-center border border-outline-var text-text-muted hover:text-blue-400 hover:border-blue-400 transition-all hover:scale-110" aria-label="LinkedIn">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-surface-var flex items-center justify-center border border-outline-var text-text-muted hover:text-white hover:border-white transition-all hover:scale-110" aria-label="GitHub">
        ...
        {/* Bottom Bar */}
        <div className="mt-16 pt-8 flex border-t justify-between items-center flex-wrap gap-4" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
          <p className="text-text-faint text-xs font-label tracking-widest">
